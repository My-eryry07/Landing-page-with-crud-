    ...
    <div class="container-fluid text-center bg-dark">
        <div class="row align-items-center" style="height: 10vh">
            ...
            <div class="promo text-center" style="margin-top:60px">
                <button type="button" class="btn btn-primary btn-circle" style="border-radius: 50%; padding: 0; width: 80px; height: 80px;">
                        ...
                        <div class="col-md-4 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-price">Harga: Rp <?php echo number_format($row['price'], 0, ',', '.'); ?>
                                    </p>
                                    <a href="#" class="btn bg-dark text-light">Beli Sekarang</a>
                                </div>
                            </div>
                        </div>
                    <?php endwhile; ?>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <a href="tel:+62123456789" class="text-light">Phone: +62 123 456 789</a </li>
                        <li>
